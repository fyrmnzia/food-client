        ...
        <footer className="footer text-base-content xl:px-24 py-10 px-4">
          <aside>
            ...
            <p className="my-5 md:w-40">
              Savor the artisty where every dish is a culinary masterpiece
            </p>
          </aside>
          <nav>
          ...
          <nav>
            ...
            <a className="link link-hover">1rifqi.firmansyah@gmail.com</a>
            <a className="link link-hover">+62 822 6298 2154</a>
